...
describe('utils date', () => {
    ...
    describe('daysBetween', () => {
        ...
        it('should calculate days correctly across month boundaries', () => {
            ...
            expect(daysBetween(date1, date2)).toBe(4); // 30, 31, 1, 2 (including start, excluding end)
        });
        ...
        it('should calculate days correctly including a leap day', () => {
            ...
            expect(daysBetween(date1, date2)).toBe(3); // 28, 29, 1 (including start, excluding end)
        });
        ...
        it('should calculate days correctly in a non-leap year', () => {
            ...
            expect(daysBetween(date1, date2)).toBe(2); // 28, 1 (including start, excluding end)
        });
        ...
        it('should calculate days correctly over a longer period', () => {
            ...
            expect(daysBetween(date1, date2)).toBe(365); // All days in 2023 (including start, excluding end)
        });
        ...
        it('should calculate days correctly over a longer period including a leap year', () => {
            ...
            expect(daysBetween(date1, date2)).toBe(366); // All days in 2024 (including start, excluding end)
        });
