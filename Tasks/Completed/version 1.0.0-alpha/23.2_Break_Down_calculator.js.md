...
## Objective
Break down the `src/calculator.js` file (currently 540 lines) into smaller, more focused files, each around 200-250 lines.
...
## File to Break Down
- `src/calculator.js` (540 lines)

## Proposed New Files

Split into 2 files:
- **`src/calculator.core.js`** (~250 lines)
...
- **`src/calculator.ui.js`** (~200 lines)
