...
## Objective
Break down the `src/utils.js` file (currently 316 lines) into smaller, more focused utility files, each around 200 lines.
...
## File to Break Down
- `src/utils.js` (316 lines)

## Proposed New Files

Split into 2 files:
- **`src/utils.date.js`** (~200 lines)
...
- **`src/utils.currency.js`** (~200 lines)
